...
if __name__ == '__main__':
    ...
    parser.add_argument('--force', action='store_true', dest='force', default=False, help='Force reload of player stats')
    parser.add_argument('--find', action='store_true', dest='find', default=False,
    ...
    parser.add_argument('--loadnfl', action='store', dest='load_nfl', metavar='YEAR',
            help='Use with --week flag, load the team rosters for the league/week into the db from yahoo')
    parser.add_argument('--loadstats', action='store_true', dest='stats', default=False,
    ...
    if args.find:
        ...
        for week in args.week:
            NFLMatchup.load_matchups(args.load_nfl, int(week))
    elif args.stats:
        Player.query_manager.set_sleep(int(args.sleep))
        for week in args.week:
